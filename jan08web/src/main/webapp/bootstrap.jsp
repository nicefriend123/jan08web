    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
            <div class="container px-5">
                <a class="navbar-brand fw-bold" href="#page-top">NKcorporation</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                        <li class="nav-item"><a class="nav-link me-lg-3" href="./board">게시판</a></li>
		...
		<div class="m-5 p-5 border-top border-bottom border-success">
        	...
        	<div class="container bg-info text-white"> 
        		구역
        		container라는 구역안에 백그라운드색은 info 색 글자색은 흰색
        		<div class="m-5 mb-0 bg-primary">구역2</div>
        		<div class="mx-2 my-4 py-5 bg-secondary">구역3
        			mx 양옆 2만큼 빼줍니다
        			p는 padding 위아래 5만큼 여백을준다
        		</div>
        ...
        <footer class="bg-black text-center py-5">
            <div class="container px-5">
                <div class="text-white-50 small">
                    <div class="mb-2">&copy; Nkcorporation. All Rights Reserved.</div>
                    <a href="#!">Privacy</a>
